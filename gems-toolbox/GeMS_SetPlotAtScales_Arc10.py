...
def main(parameters):
    ...
    rawurl = 'https://raw.githubusercontent.com/usgs/gems-tools-arcmap/master/gems-toolbox/GeMS_SetPlotAtScales_Arc10.py'
    ...
    inFc = parameters[0]
    minSeparation_mm = float(parameters[1])
    maxPlotAtScale = float(parameters[2])
    ...
    outTable = os.path.join(gdb, 'xxxPlotAtScales')
