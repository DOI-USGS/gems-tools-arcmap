...
myAttribDict = {
    'SamplePretreatment':'Procedure(s) by which some samples were pretreated, before carbon extraction, to minimize the effects of later contamination.',
    'AnalysisMethod':'How carbon isotopes were analyzed. Not reported for all samples. AMS = accelerator mass spectrometry.',
    'SampleElevationFt':'Elevation at which sample was collected, in feet above datum.',
    'delta_13C':'Observed 13C : 12C ratio, reported as an offset, in parts per thousand, relative to standard value PDB. Not reported for all samples.',
    'CalibratedAge':'2-sigma age range determined from CALIB5.2 program (Stuiver and Reimer, 1993). Rounded to nearest decade. Calculated from reservoir-corrected age for marine samples. Also known as calendrical age.',
    'Location':'Brief text description of locale at which sample was collected.',
    'MaterialDated':'Type of material dated. Values include marine shell, peat, detrital wood, etc.',
    'Lab_no':'Laboratory identifier for analyzed sample.',
    'ConventionalAge':'Age reported by laboratory. Reflects assumed constant 14C production rate and accepted 14C decay constant. Ages normalized to delta 13C = -25.0 per mil, +/- 1 sigma, lab error multiplier = 1.',
    ...
    'Significance':'Brief discussion of significance of reported age.',
    'StratigraphicContext':'Stratigraphic horizon from which sample was collected.',
    'Phase':'Integer index number of time period within late Pleistocene history of map area. Nine phases are recognized.'
    }
