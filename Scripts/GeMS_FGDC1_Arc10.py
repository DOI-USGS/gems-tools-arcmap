...
versionString = 'GeMS_FGDC1_Arc10.py, version of version of 8 May 2023'
rawurl = 'https://raw.githubusercontent.com/doi-usgs/gems-tools-arcmap/master/Scripts/GeMS_FGDC1_Arc10.py'
