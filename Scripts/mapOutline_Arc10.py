...
def main(parameters):
    ...
    SELongStr = parameters[0]
    SELatStr = parameters[1]
    dLong = float(parameters[2])
    dLat = float(parameters[3])
    ticInterval = float(parameters[4])
    ...
    outgdb = parameters[6]
    outSpRef = parameters[7]
    scratch = parameters[8]
